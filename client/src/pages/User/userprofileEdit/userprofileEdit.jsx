...
const UserprofileEdit = () => {
  ...
  return (
     <div className="signup-container">
          ...
          <Form
            layout="vertical"
            onFinish={editupOnClick}
          >
            <Form.Item label="First Name" required>
              <Input value={user.firstname} onChange={(e) => onChange(e, 'firstname')} />
            </Form.Item>
            <Form.Item label="Last Name" required>
              <Input value={user.lastname} onChange={(e) => onChange(e, 'lastname')} />
            </Form.Item>
            <Form.Item label="Email" required>
              <Input value={user.email} onChange={(e) => onChange(e, 'email')} type="email" />
            </Form.Item>
            ...
            <Form.Item label="Blood Group" required>
              <Input value={user.bloodgroup} onChange={(e) => onChange(e, 'bloodgroup')} />
            </Form.Item>
            <Form.Item label="Phone Number" required>
              <Input value={user.phonenumber} onChange={(e) => onChange(e, 'phonenumber')} />
            </Form.Item>
            <Form.Item label="Address" required>
              <TextArea value={user.address} onChange={(e) => onChange(e, 'address')} rows={4} />
            </Form.Item>
            <Form.Item label="Image" valuePropName="file">
            <Upload
    fileList={user.image ? [{ url: user.image, name: 'Uploaded Image', status: 'done' }] : []} // Display uploaded image if exists
    showUploadList={true}
